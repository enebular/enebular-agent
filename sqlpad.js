...
var packageJson = require('sqlpad/package.json');
var app = express();
...
============================================================================= */
require('sqlpad/lib/add-cli-config-to-app.js')(app);
require('sqlpad/lib/add-db-to-app.js')(app);
require('sqlpad/lib/add-cipher-decipher-to-app.js')(app);
// require('sqlpad/lib/add-open-admin-registration-to-app.js')(app);
require('sqlpad/lib/add-email-domain-whitelist-to-app.js')(app);
...
app.set('views', path.join(__dirname, 'node_modules/sqlpad/views'));
...
// app.use(favicon(__dirname + '/node_modules/sqlpad/public/images/favicon.ico'));
...
app.use(express.static(path.join(__dirname, 'node_modules/sqlpad/public')));
...
============================================================================= */
// require('sqlpad/routes/oauth.js')(app, passport);
require('sqlpad/routes/homepage.js')(app);
require('sqlpad/routes/onboarding.js')(app);
require('sqlpad/routes/user-admin.js')(app);
require('sqlpad/routes/connections.js')(app);
require('sqlpad/routes/queries.js')(app);
require('sqlpad/routes/run-query.js')(app); // ajaxy route used for executing query and getting results
require('sqlpad/routes/download-results.js')(app); // streams cached query results to browser
require('sqlpad/routes/schema-info.js')(app);
require('sqlpad/routes/configs.js')(app);
require('sqlpad/routes/tags.js')(app);
